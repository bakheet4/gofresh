                ...
                <div class="text-muted font-13">
                    <form method="POST" action="{{ route('purchase.code',['token'=>bcrypt('step_3')]) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" value="NullJungle" class="form-control" id="username" name="username" required>
                        </div>

                        <div class="form-group">
                            <label for="purchase_code">Purchase Code</label>
                            <input type="text" value="NullJungle.com" class="form-control" id="purchase_key" name="purchase_key" required>
                        </div>
